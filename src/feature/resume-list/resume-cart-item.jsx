  ...
  return (
    <div>
      <Link to={`/dashboard/resume/${item.documentId}/edit`} className="group">
        <div className=" mt-6 px-12 py-24 border border-slate-600/20 bg-white/20 flex items-center justify-center rounded-t-xl shadow-md cursor-pointer group-hover:scale-105 duration-150 transition-all ease-in-out group-hover:shadow-2xl">
          <File />
          <h2>Edit Resume</h2>
        </div>
